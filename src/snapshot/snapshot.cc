...
bool Snapshot::Initialize(Isolate* isolate) {
  ...
  std::cout << "StartUP data:" << &startup_snapshot_data << " "
            << startup_data.length() << std::endl;
  std::cout << "read-only data:" << &read_only_data << " "
            << read_only_data.length() << std::endl;
  std::cout << "share heap data:" << &shared_heap_data << " "
            << shared_heap_data.length() << std::endl;
