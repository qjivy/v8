...
V8_WARN_UNUSED_RESULT V8_INLINE AllocationResult HeapAllocator::AllocateRaw(
  ...
  if (V8_ENABLE_THIRD_PARTY_HEAP_BOOL) {
    ...
    if (V8_UNLIKELY(large_object)) {
      std::cout << "-----AllocateRaw-Templated for large object "
      ...
      switch (type) {
        case AllocationType::kYoung:
          std::cout << "-----AllocateRaw-Templated for kYoung " << __FUNCTION__
                    << " " << __FILE__ << " "
                    << " " << __LINE__ << " " << std::endl;
          allocation =
        ...
        case AllocationType::kMap:
          std::cout << "-----AllocateRaw-Templated for kMap " << __FUNCTION__
                    << " " << __FILE__ << " "
                    << " " << __LINE__ << " " << std::endl;
          allocation =
        ...
        case AllocationType::kOld:
          std::cout << "-----AllocateRaw-Templated for kOld " << __FUNCTION__
                    << " " << __FILE__ << " "
                    << " " << __LINE__ << " " << std::endl;
          allocation =
              old_space()->AllocateRaw(size_in_bytes, alignment, origin);
        ...
        case AllocationType::kCode:
          std::cout << "-----AllocateRaw-Templated for kCode " << __FUNCTION__
                    << " " << __FILE__ << " "
                    << " " << __LINE__ << " " << std::endl;
        ...
        case AllocationType::kReadOnly:
          std::cout << "-----AllocateRaw-Templated for kReadOnly "
                    << __FUNCTION__ << " " << __FILE__ << " "
                    << " " << __LINE__ << " " << std::endl;
        ...
        case AllocationType::kSharedMap:
          std::cout << "-----AllocateRaw-Templated for kSharedMap "
                    << __FUNCTION__ << " " << __FILE__ << " "
                    << " " << __LINE__ << " " << std::endl;
        ...
        case AllocationType::kSharedOld:
          std::cout << "-----AllocateRaw-Templated for kSharedOld "
                    << __FUNCTION__ << " " << __FILE__ << " "
                    << " " << __LINE__ << " " << std::endl;
          allocation = shared_old_allocator_->AllocateRaw(size_in_bytes,
                                                          alignment, origin);
...
V8_WARN_UNUSED_RESULT V8_INLINE HeapObject HeapAllocator::AllocateRawWith(
  ...
  if (allocation == AllocationType::kYoung) {
    std::cout << "-----AllocateRawWith for kYoung " << __FUNCTION__ << " "
              << __FILE__ << " "
              << " " << __LINE__ << " " << std::endl;
    ...
    std::cout << "-----AllocateRawWith for kOld " << __FUNCTION__ << " "
              << __FILE__ << " "
              << " " << __LINE__ << " " << std::endl;
  ...
  switch (mode) {
    case kLightRetry:
      std::cout << "-----AllocateRawWith with kLightRetry mode " << __FUNCTION__
                << " " << __FILE__ << " "
                << " " << __LINE__ << " " << std::endl;
      ...
      break;
    case kRetryOrFail:
      std::cout << "-----AllocateRawWith with kRetryOrFail mode "
                << __FUNCTION__ << " " << __FILE__ << " "
                << " " << __LINE__ << " " << std::endl;
  ...
  if (result.To(&object)) {
    // std::cout<<"-----AllocateRawWith result: "<<result<<" object:
    // "<<object<<std::endl;
    std::cout << "-----AllocateRawWith object address: " << object.address()
              << " allo result address: " << result.ToAddress() << std::endl;
    // object.Print();
    return object;
  }
  return HeapObject();
